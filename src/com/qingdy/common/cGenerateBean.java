...
public final class cGenerateBean {
		...
		static {
			...
			map.put("UNSIGNED INT", "Integer");
			map.put("INT", "Integer");
			map.put("INTEGER", "Integer");
			map.put("UNSIGNED TINYINT", "Integer");
			map.put("MEDIUMINT", "Integer");
			map.put("SMALLINT", "Integer");
			map.put("UNSIGNED SMALLINT", "Integer");
		...
		public void tableToBean(Connection connection, String tableName) throws SQLException {
			...
			sb.append("package " + "com.qingdy.domain" + ";");
			sb.append(LINE);
			...
			String endPath = paths + "/src/" + "com/qingdy/domain/";
