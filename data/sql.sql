...
#SELECT * FROM QingDyDB.qd_product left outer join QingDyDB.qd_member on QingDyDB.qd_product.uid=QingDyDB.qd_member.uid left outer join QingDyDB.areas on QingDyDB.qd_product.clientlocation=QingDyDB.areas.areaid left outer join QingDyDB.usersofloan on QingDyDB.qd_product.usesofloanid=QingDyDB.usersofloan.uolid left outer join QingDyDB.clients on QingDyDB.qd_product.clientid=QingDyDB.clients.ctid left outer join QingDyDB.ratetype on QingDyDB.qd_product.ratetypeid=QingDyDB.ratetype.rid left outer join QingDyDB.repaymethod on QingDyDB.qd_product.repaymentmethodid=QingDyDB.repaymethod.rid left outer join QingDyDB.speciality on QingDyDB.qd_product.ptype=QingDyDB.speciality.speid;
