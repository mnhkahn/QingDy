...
SELECT * FROM QingDyDB.qd_news left outer join QingDyDB.qd_member on QingDyDB.qd_news.uid=QingDyDB.qd_member.uid left outer join QingDyDB.newsclasses on QingDyDB.newsclasses.ncid=QingDyDB.qd_news.classes;